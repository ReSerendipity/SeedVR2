/**
 * Video Restore page object for the SeedVR2 WebUI.
 *
 * NOTE: The product has been reworked into a single unified restore
 * workbench (restore.html). Video restore lives on the "single file"
...
export class VideoRestorePage extends BasePage {
  ...
  readonly compareToolbar: Locator;
  ...
  constructor(page: Page) {
    ...
    this.progressDetail = page.locator('#progressDetail');
    this.progressFps = page.locator('#progressFps');
    this.progressStage = page.locator('#progressStage');
    ...
    this.compareToolbar = page.locator('#compareToolbar');
  ...
  /** Upload a video file through the unified restore file input. */
