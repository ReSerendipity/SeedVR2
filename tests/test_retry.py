...
class TestExponentialBackoffCalculation:
    ...
    @pytest.mark.asyncio
    @patch("bin.integrated_app.utils.retry.asyncio.sleep", new_callable=AsyncMock)
    @patch("bin.integrated_app.utils.retry.random.uniform", return_value=0.0)
...
class TestJitter:
    ...
    @pytest.mark.asyncio
    @patch("bin.integrated_app.utils.retry.asyncio.sleep", new_callable=AsyncMock)
    @patch("bin.integrated_app.utils.retry.random.uniform", return_value=0.5)
    ...
    @pytest.mark.asyncio
    @patch("bin.integrated_app.utils.retry.asyncio.sleep", new_callable=AsyncMock)
    @patch("bin.integrated_app.utils.retry.random.uniform")
    ...
    @pytest.mark.asyncio
    @patch("bin.integrated_app.utils.retry.asyncio.sleep", new_callable=AsyncMock)
    @patch("bin.integrated_app.utils.retry.random.uniform", return_value=3.0)
