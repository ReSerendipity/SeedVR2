...
本模块属于 SeedVR2 视频修复项目的 AI 推理优化层，提供多种视频处理增强技术，
包括帧插值、光流对齐、深度感知处理、因果条件推理、帧分析和分层退化处理，
用于提升视频修复的整体质量和流畅度。

核心技术栈:
- PyTorch: 神经网络推理与张量计算
- NumPy: 数值计算
- RAFT/PyFlow: 光流估计与运动补偿
- RIFE/DAIN/IFRNet: 帧插值模型
- OpenCV: 基础图像处理与视频I/O
...
注意: 外部依赖 (rife, raft) 为可选导入，模块缺失时优雅降级
"""
